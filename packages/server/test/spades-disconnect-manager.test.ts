...
} from '../src/spades/disconnect-manager.js';
...
describe('SpadesDisconnectManager', () => {
  ...
  it('cancels takeover when the same player reconnects in time', async () => {
  ...
  it('tracks simultaneous disconnects independently', () => {
